...
public class LoginAndConnectivity_old extends BaseTest {
    ...
    public void invalidLogin(){
        ...
        loginMob.login("auto_mobile1", "1111", "auto_mob1", "automation", false);
    ...
    public void validLoginWithRememberMeAndCheckRememberMe(){
        ...
        loginMob = new MobileLogin();
        loginMob.login("auto_mobile1", "1", "auto_mob1", "automation", true);
    ...
    public void checkPasswordContainSpecialCharacter(){
        ...
        loginMob = new MobileLogin();
        loginMob.login(employeeCode, "Ali&$%#@*3658", "auto_mob1", "automation", false);
