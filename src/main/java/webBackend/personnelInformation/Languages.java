...
public class Languages extends WebBase {
    ...
    public void addLanguageWithAssertion(String language, String read, String written, String spoken){
        ...
        softAssert.assertEquals(driver.findElement(By.name("Langxxx")).getDomAttribute("value"), language, "-Issue Language");
    ...
    public void editLanguage(){
        ...
        softAssert.assertEquals(driver.findElement(By.name("Langxxx")).getDomAttribute("value"), "English", "-Issue Language");
